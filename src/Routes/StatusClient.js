...
import NavHomeClient from '../Components/NavHomeClient';
...
function StatusClient({connected}){
    ...
    return(
            <Grommet full theme={"dark"} style={{overflow: "unset"}}>
                ...
                >
                    <Box gridArea="nav" background="light-5"> <NavHomeClient childConnected={connected} setNavClient={setNavClient} /> </Box>
